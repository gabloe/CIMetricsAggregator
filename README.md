...
Step 5:<br />
Start both nginx, and uwsgi services using the configurations found in the repo.  nginx.conf needs to be copied to /etc/nginx/sites-enabled/ in order for the configuration to be loaded properly<br /><br />
Step 6:<br />
